...
public class autoCenterToRightSwitchTwoCube extends CommandGroup {
    ...
    public autoCenterToRightSwitchTwoCube() {
        ...
        addSequential(new autoTurn(35, 0.3, 1), 3);
        addSequential(new moveDistanceX(40, 0.4, true), 3);
        addSequential(new autoTurn(0.01, 0.35, -1), 1.5);
        addSequential(new moveDistanceX(40, 0.4, true), 1.5);
        ...
        addSequential(new moveDistanceX(12, 0.3, true), 1);
        addParallel(new autoLift(RobotMap.switchHeight));
        addSequential(new moveDistanceX(50, -0.4, true), 1);
        addSequential(new autoTurn(-5, 0.45, 1), 1);
        addSequential(new moveDistanceX(42, 0.3, true));
