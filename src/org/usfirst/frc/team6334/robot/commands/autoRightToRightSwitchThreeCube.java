 ...
 *
 */
public class autoRightToRightSwitchThreeCube extends CommandGroup {

    public autoRightToRightSwitchThreeCube() {
        ...
        addParallel(new autoLift(RobotMap.switchHeight));
        addSequential(new moveDistanceX(30, -0.5, true), 1);
        addSequential(new autoTurn(-145, 0.45, -1), 1);
        addSequential(new moveDistanceX(12, 0.5, true), 1);
    }
}
