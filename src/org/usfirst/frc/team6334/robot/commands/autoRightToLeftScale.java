...
//        addSequential(new autoTurn(-0.01, 0.3, 1));			//Turn towards scale
//        addSequential(new moveDistanceX(6, 0.1));			//Move forward
//        addSequential(new moveDistanceX(28, 0.5));			//Move forward
//        addSequential(new moveDistanceX(3, 0.2));			//Move forward
//        addSequential(new autoTurn(80, 0.3, 1));			//Actually turn to scale
//        addSequential(new moveDistanceX(1, 0.2));			//Straighten out
//        addSequential(new autoIntake(true, 0.5));			//Eject cube
